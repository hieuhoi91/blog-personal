  ...
  return (
    <FrameSection className='flex flex-col items-center'>
      ...
      <div className='flex flex-col items-center gap-2'>
        <span className='text-text-primary mb-2 font-semibold'>
          Join 70,000 subscribers!
        </span>
        <div className='border-hover-text flex h-[40px] w-full justify-center rounded-full border'>
          <input
            type='text'
            placeholder='Email address...'
            className='w-full rounded-full border-0 px-6 text-center text-sm focus:ring-0'
          />
        </div>
